...
const ICON_URLS = {
  phone: "/email-signature-icons/icon-phone-original.png",
  web: "/email-signature-icons/icon-web-original.png",
  location: "/email-signature-icons/icon-location-original.png",
};
